// ============================================================
// Recommendation Service — SQL-based, no AI calls
// Customers: gigs in categories they booked before, then popular.
// Workers: published jobs matching their gig categories.
// ============================================================
...
const recommendationService = {
    ...
    // Active gigs for a customer, category-affinity first.
    ...
    // Published jobs for a worker, matching their gig categories first.
